...
path = 'C:/Users/hp/Desktop/python jupyter notebooks/code_python/problem_1/python_p1/excel_matrix_problem1.mat'
component_information = sci.loadmat(path)["matrix"]
domain = Domain()
